...
export default function RegisterPage() {
  ...
  // Password strength helper (at least 6 chars)
      ...
      >
        <Card className="w-full max-w-md p-8 space-y-6 bg-white backdrop-blur">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            {success && (
              <div className="text-green-600 text-sm text-center bg-green-50 border border-green-200 rounded-lg p-2 mb-2">{success}</div>
            )}
            {error && (
